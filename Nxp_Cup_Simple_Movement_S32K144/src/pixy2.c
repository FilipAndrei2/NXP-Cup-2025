...
*                                       GLOBAL FUNCTIONS
==================================================================================================*/
void Pixy2Init(I2c_AddressType PixyI2cAddress, I2c_AddressType PixyI2cAddress2, uint8 PixyI2cChannel){
    Pixy2Instance.I2cAddress = PixyI2cAddress;
    Pixy2Instance.I2cChannel = PixyI2cChannel;
    Pixy2Instance.I2cAddress2 = PixyI2cAddress2;
}

void Pixy2SetLed(uint8 Red, uint8 Green, uint8 Blue, int cameraNum){
    PixyLedSetCommand[4] = Red;
    PixyLedSetCommand[5] = Green;
    PixyLedSetCommand[6] = Blue;
	// set the adress of the corresponding camera
    setPixyAdress(cameraNum);

    I2c_SyncTransmit(Pixy2Instance.I2cChannel, &PixyLedRequest);
    I2c_SyncTransmit(Pixy2Instance.I2cChannel, &PixyLedResponse);
}

void Pixy2GetVectors(DetectedVectors *DetectedVectors, int cameraNum){
...
void setPixyAdress(int cameraNum){
	switch(cameraNum) {
			case 1:
				PixyLinesRequest.SlaveAddress = Pixy2Instance.I2cAddress;
				PixyLinesReceive.SlaveAddress = Pixy2Instance.I2cAddress;
				PixyLedRequest.SlaveAddress = Pixy2Instance.I2cAddress;
				PixyLedResponse.SlaveAddress = Pixy2Instance.I2cAddress;
			   break;
			case 2:
				PixyLinesRequest.SlaveAddress = Pixy2Instance.I2cAddress2;
				PixyLinesReceive.SlaveAddress = Pixy2Instance.I2cAddress2;
				PixyLedRequest.SlaveAddress = Pixy2Instance.I2cAddress2;
				PixyLedResponse.SlaveAddress = Pixy2Instance.I2cAddress2;
				break;
		}
}
