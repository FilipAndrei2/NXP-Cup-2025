 ...
 */
const Port_Ci_Icu_Ip_ChannelConfigType Port_Ci_Icu_Ip_4_ChannelConfig_PB_VS_0[1U] =
{
 ...
 *  @brief    PB_VS_0 PORT_CI Channels Configuration
 */
const Port_Ci_Icu_Ip_ChannelConfigType Port_Ci_Icu_Ip_2_ChannelConfig_PB_VS_0[2U] =
{
    /** @brief IcuPortC_BTN0 */
    {
        /** @brief Assigned Port_Ci channel id */
 ...
 *  @brief    PB_VS_0 Default PORT_CI IP Configuration
 */
const Port_Ci_Icu_Ip_ConfigType Port_Ci_Icu_Ip_2_Config_PB_VS_0 = 
{
    /** @brief Number of Port_Ci channels in the Icu configuration */
    (uint8)2U,
    /** @brief Pointer to the array of Port_Ci channel configurations */
    &Port_Ci_Icu_Ip_2_ChannelConfig_PB_VS_0
};
#define ICU_STOP_SEC_CONFIG_DATA_UNSPECIFIED
#include "Icu_MemMap.h"
#define ICU_START_SEC_CONFIG_DATA_UNSPECIFIED
 ...
 *  @brief    PB_VS_0 PORT_CI Channels Configuration
 */
const Port_Ci_Icu_Ip_ChannelConfigType Port_Ci_Icu_Ip_0_ChannelConfig_PB_VS_0[1U] =
{
    /** @brief IcuPortChannel_DISTANCE */
    {
        /** @brief Assigned Port_Ci channel id */
        11U,
        /** @brief Port_Ci Edge type */
        PORT_CI_ICU_BOTH_EDGES,
        /** @brief Callback Pointer */
        &Icu_ReportEvents,
        /** @brief The notification functions */
        NULL_PTR,
 ...
 *  @brief    PB_VS_0 Default PORT_CI IP Configuration
 */
const Port_Ci_Icu_Ip_ConfigType Port_Ci_Icu_Ip_0_Config_PB_VS_0 = 
{
    /** @brief Number of Port_Ci channels in the Icu configuration */
    (uint8)1U,
    /** @brief Pointer to the array of Port_Ci channel configurations */
    &Port_Ci_Icu_Ip_0_ChannelConfig_PB_VS_0
};
#define ICU_STOP_SEC_CONFIG_DATA_UNSPECIFIED
#include "Icu_MemMap.h"
