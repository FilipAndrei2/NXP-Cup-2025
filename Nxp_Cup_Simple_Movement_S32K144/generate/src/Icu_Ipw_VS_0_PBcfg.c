 ...
 */
const Icu_Ipw_ChannelConfigType Icu_Ipw_IpChannelConfig_PB_VS_0[4U] =
{
    ...
    /** @brief Receiver_Input */
    {
        ...
        &Port_Ci_Icu_Ip_4_ChannelConfig_PB_VS_0[0U],
    ...
    /** @brief BTN0_ICU */
    {
        ...
        NULL_PTR,
        /** @brief Port Ci IP channel pointer */
        &Port_Ci_Icu_Ip_2_ChannelConfig_PB_VS_0[0U],
    #if (STD_ON == CMP_IP_USED)
        /** @brief Cmp IP channel pointer */
        NULL_PTR,
    #endif  /* CMP_IP_USED */
    ...
    /** @brief BTN1_ICU */
    {
        ...
        NULL_PTR,
        /** @brief Port Ci IP channel pointer */
        &Port_Ci_Icu_Ip_2_ChannelConfig_PB_VS_0[1U],
    #if (STD_ON == CMP_IP_USED)
        /** @brief Cmp IP channel pointer */
        NULL_PTR,
    #endif  /* CMP_IP_USED */
...
const Icu_Ipw_IpConfigType Icu_Ipw_IpConfig_PB_VS_0[3U] =
{
    {
        /** @brief IP type */
        ICU_PORT_CI_MODULE,
    ...
    },
    {
        ...
        NULL_PTR,
        /** @brief pointer to Port Ci HW configuration of instance */
        &Port_Ci_Icu_Ip_2_Config_PB_VS_0,
    #if (STD_ON == CMP_IP_USED)
        /** @brief pointer to Cmp HW configuration of instance */
        NULL_PTR,
    #endif  /* CMP_IP_USED */
    ...
    },
    {
        ...
        NULL_PTR,
        /** @brief pointer to Port Ci HW configuration of instance */
        &Port_Ci_Icu_Ip_4_Config_PB_VS_0,
    #if (STD_ON == CMP_IP_USED)
        /** @brief pointer to Cmp HW configuration of instance */
        NULL_PTR,
    #endif  /* CMP_IP_USED */
