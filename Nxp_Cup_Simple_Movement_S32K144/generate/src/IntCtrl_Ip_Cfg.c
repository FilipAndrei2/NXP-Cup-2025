...
static const IntCtrl_Ip_IrqConfigType aIrqConfiguration[] = {
    ...
    {FTM3_Ch4_Ch5_IRQn, (boolean)TRUE, 0U, FTM_3_CH_4_CH_5_ISR},
    {LPUART2_RxTx_IRQn, (boolean)TRUE, 0U, LPUART_UART_IP_2_IRQHandler},
    {PORTC_IRQn, (boolean)TRUE, 0U, PORT_CI_ICU_IP_C_EXT_IRQ_ISR},
    {PORTA_IRQn, (boolean)TRUE, 0U, PORT_CI_ICU_IP_A_EXT_IRQ_ISR},
};
