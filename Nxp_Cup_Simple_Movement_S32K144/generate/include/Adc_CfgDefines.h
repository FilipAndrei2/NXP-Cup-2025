...
*/
#define ADC_TIMEOUT_COUNTER                 (10000UL)
...
*/
#define AdcChannel_1                       (0x0U)
#define Potentiometru                       (0x1U)
...
#define Potentiometru2                                (0U)

/**
* @brief           Symbolic names of groups - ecuc 2108 compliant.
*/

#define AdcConf_AdcGroup_Potentiometru2               (0U)
