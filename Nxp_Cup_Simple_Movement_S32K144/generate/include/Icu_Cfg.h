...
#define BTN0_ICU                     (IcuConf_IcuChannel_BTN0_ICU)
#define IcuConf_IcuChannel_BTN0_ICU  ((Icu_ChannelType)1U)
#define BTN1_ICU                     (IcuConf_IcuChannel_BTN1_ICU)
#define IcuConf_IcuChannel_BTN1_ICU  ((Icu_ChannelType)2U)
#define DISTANTA_SENZOR                     (IcuConf_IcuChannel_DISTANTA_SENZOR)
#define IcuConf_IcuChannel_DISTANTA_SENZOR  ((Icu_ChannelType)3U)
